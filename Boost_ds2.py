...
opt_clf_inner = tree.DecisionTreeClassifier(criterion='gini', max_depth=10, random_state= random_seed)
opt_clf = AdaBoostClassifier(opt_clf_inner, n_estimators=1000, random_state=random_seed)
...
# N Estimators
opt_clf_inner = tree.DecisionTreeClassifier(criterion='gini', max_depth=7, random_state= random_seed)
opt_clf = AdaBoostClassifier(opt_clf_inner, random_state=random_seed)

param_range = np.arange(1,2001,50)
