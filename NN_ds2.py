...
opt_clf = MLPClassifier(**best_params, random_state=random_seed)
...
# hidden_layer_one = np.arange(1,251,10)
# param_range = [[i,10] for i in hidden_layer_one]
#
hidden_layer_two = np.arange(1,251,10)
param_range = [[35,j] for j in hidden_layer_two]
